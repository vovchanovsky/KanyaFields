...
{
    public class AuthenticationSvcResultQueueListener : BackgroundService
    {
        public AuthenticationSvcResultQueueListener(
            ...
            IConfiguration configuration)
        {
            ...
            _topicName = $"ApiSvc_AuthenticationSvc_Response_Queue_{_synchronizer.ApplicationInstanceId}";
        }
